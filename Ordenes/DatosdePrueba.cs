...
public class DatosdePrueba
{
    ...
    private void cargarProductos()
    {
        ...
        Producto p3 = new Producto(3, "Monitor", 2000);
        ListadeProductos.Add(p3);

        Producto p4 = new Producto(4, "tablet", 500);
        ListadeProductos.Add(p4);
    }

    private void cargarClientes()
    {
        Cliente c1 = new Cliente(1, "Juan", "9966486");
        ListadeClientes.Add(c1);

        Cliente c2 = new Cliente(2, "Pedro", "89876554");
        ListadeClientes.Add(c2);
    }

    private void cargarVendedores()
    {
        Vendedor v1 = new Vendedor(1, "Jose", "V-001");
        ListadeVendedores.Add(v1);

        Vendedor v2 = new Vendedor(2, "Pablo", "V-002");
     ...
     public void CrearOrden()
     {
        ...
        while(true)
        {
            ...
            if (producto == null)
            {
                ...
                Console.WriteLine("Producto agregado: " + producto.Descripcion + " con precio de lps." + producto.Precio);
        ...
        Console.WriteLine("");
        Console.WriteLine("Subtotal de: " + nuevaOrden.Subtotal);
