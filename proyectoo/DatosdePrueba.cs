...
public class DatosdePrueba
{
    ...
    public DatosdePrueba()
    {
     ...
     {
         Producto P1 = new Producto(1,"Azucar",200);
         ListaProductos.Add(P1);
         Producto P2 = new Producto(2,"Harina",300);
         ListaProductos.Add(P2);
         Producto P3 = new Producto(3,"Manteca",150);
         ListaProductos.Add(P3);
         Producto P4 = new Producto(4,"Aceite",250);
         ListaProductos.Add(P4);
         Producto P5 = new Producto(5,"Carnes",700);
         ListaProductos.Add(P5);
         Producto P6 = new Producto(6,"Leche",500);
         ListaProductos.Add(P6);

    } 
    private void cargarAcreedores()
    {
        Acreedor a1= new Acreedor(1,"Pulperia 3 HERMANOS","2000");
        ListadeAcreedores.Add(a1);
        Acreedor a2= new Acreedor(2," Bodega ESPINOZA","1588");
        ListadeAcreedores.Add(a2);
        Acreedor a3= new Acreedor(3,"Abarroteria","1999");
